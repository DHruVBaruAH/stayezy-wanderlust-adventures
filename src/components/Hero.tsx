    ...
    <section className='relative min-h-[80vh] flex items-center justify-center overflow-hidden'>
      ...
      <div className='relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto'>
        ...
        <p className='text-xl md:text-2xl text-white/90 mb-8 max-w-2xl mx-auto animate-fade-in'>
          Find unique stays and experiences around the world with Stayezy. Your
        ...
        <form
          ...
          className='bg-white/95 backdrop-blur-sm rounded-2xl p-6 shadow-2xl max-w-2xl mx-auto animate-fade-in'>
